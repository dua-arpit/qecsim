...
def parallel_step_p(code,hadamard_vec,hadamard_mat,error_model, decoder, max_runs,error_probability):
    result= app_def.run_def(code,hadamard_vec,hadamard_mat, error_model, decoder, error_probability, max_runs)
    return result
    ...
    for code_index,code in enumerate(codes_and_size):
        ...
        if code_name=="random":
            ...
            for realization_index in range(realizations):
                ...
                p=mp.Pool()
                func=partial(parallel_step_p,code,hadamard_vec,hadamard_mat,error_model, decoder, max_runs)
